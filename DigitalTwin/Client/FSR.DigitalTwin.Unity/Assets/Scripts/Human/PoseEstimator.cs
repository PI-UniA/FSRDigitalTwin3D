...
/// </summary>
    ...
    // Calls the appropriate preprocessing function to prepare the input for the selected model and hardware
    ...
    private void ProcessOutput(IWorker engine)
    {
        ...
        {
            // Determine the key point locations
            poses = Utils.DecodeMultiplePoses(heatmaps, offsets, displacementFWD, displacementBWD,
                stride: stride, maxPoseDetections: maxPoses, scoreThreshold: scoreThreshold, 
                nmsRadius: nmsRadius);
        }
